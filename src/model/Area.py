...
class Area:
    def __init__(self, area):
        ...
        self.balance_penalty = area["balance_penalty"]
    ...
    def update_cancel_ride(self, customer_id, no_drivers=False):
        self.customers.remove(customer_id)
        self.stats["canceled"] += 1
        if (no_drivers):
            self.stats["canceled_no_drivers"] += 1
